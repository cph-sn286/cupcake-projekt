...
INSERT INTO `orderline` VALUES (1,1,1,2,0);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_orders_orderline1` FOREIGN KEY (`order_id`) REFERENCES `orderline` (`order_id`),
...
INSERT INTO `orders` VALUES (1,1,'18:30',10,'2021-04-19 22:01:56');
...
INSERT INTO `users` VALUES (1,'rene@123','123','customer',500),(3,'123@','','customer',0),(9,'test@test','2','customer',0);
...
-- Dump completed on 2021-04-20  9:47:57
