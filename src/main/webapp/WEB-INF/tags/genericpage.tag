...
<header class="d-flex flex-column flex-md-row align-items-center p-3 pb-0 px-md-4 mb-4 bg-white border-bottom shadow-sm">
    ...
    <nav class="my-2 my-md-0 me-md-3">
        ...
        <a class="p-2 text-dark" href="${pageContext.request.contextPath}/fc/customerpage">Indkøbskurv</a>
...
<div id="body" class="container" style="min-height: 20vh;">
    <img src="${pageContext.request.contextPath}/images/header_grafik.png" class="img-fluid mb-4"/>
    <jsp:doBody/>
</div>
